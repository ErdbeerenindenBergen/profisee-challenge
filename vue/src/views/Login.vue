<template>
  <body>
    <form class="form-signin" @submit.prevent="login">
      ...
      <input type="text" id="username" class="form-control" placeholder="Email" v-model="user.username" required
        autofocus />
      <br />
      ...
      <p>If you haven't used Bespoked Bikes...</p>
      <router-link :to="{ name: 'register' }" class="register-link">please register here.</router-link>
    </form>
  </body>
</template>
